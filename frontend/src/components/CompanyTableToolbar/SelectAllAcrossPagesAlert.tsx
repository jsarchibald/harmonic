...
const SelectAllAcrossPagesAlert = ()=> {
    ...
    const toggleSelectAllAcrossPages = ()=> {
        tableSelectionContext?.setSelectAllAcrossPages(!tableSelectionContext?.selectAllAcrossPages)
    }
    ...
    <Box>
      <Alert severity="info">
        ...
        <Link component="button" sx={{ fontWeight: "bold" }} onClick={toggleSelectAllAcrossPages}>
          {action}
        </Link>
      </Alert>
